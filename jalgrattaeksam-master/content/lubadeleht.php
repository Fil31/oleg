<?php
	...
	$kask = $yhendus->prepare("SELECT id, eesnimi, perekonnanimi, teooriatulemus, hind2, ringtee, t2nav, luba FROM jalgrattaeksam;");
	$kask->bind_result($id, $eesnimi, $perekonnanimi, $teooriatulemus, $hind2, $ringtee, $t2nav, $luba);
	$kask->execute();
