    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="?page=registreerimine">Регистрация</a></li>
                <li class="nav-item"><a class="nav-link" href="?page=teooriaeksam">Оценка 1</a></li>
                <li class="nav-item"><a class="nav-link" href="?page=slaalom">Оценка 2</a></li>
                <li class="nav-item"><a class="nav-link" href="?page=ringtee">Оценка 3</a></li>
                <li class="nav-item"><a class="nav-link" href="?page=tanav">Результаты</a></li>
